...
%>
    <div class="parte-container">
        <h2>Parte numero <%= i++ %> con ID <%= parte.getId() %> </h2>
        <div>
            <table>
                <thead>
                    <tr class="main-row">
                ...
                <tbody>
                    ...
                    <tr class="employee-rows">
                        <th colspan="10">Datos del empleado</th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
                    ...
                    <tr class="location-rows">
                        <th colspan="10" >Datos de la localización</th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
                    ...
                    <tr class="vehicle-rows">
                        <th colspan="10">Datos del vehículo</th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
